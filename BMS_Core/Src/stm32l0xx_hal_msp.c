...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC_IN1
    */
    HAL_GPIO_DeInit(GPIOA, VOLTAGE_Pin|CURRENT_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = Putty_TX_Pin|Putty_RX_Pin;
  ...
  /* USER CODE END USART4_MspInit 0 */
    ...
    PC11     ------> USART4_RX
    */
    GPIO_InitStruct.Pin = Server_TX_Pin|Server_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, Putty_TX_Pin|Putty_RX_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PC11     ------> USART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, Server_TX_Pin|Server_RX_Pin);
  ...
  /* USER CODE END USART5_MspDeInit 0 */
    ...
    PD2     ------> USART5_RX
    */
    HAL_GPIO_DeInit(MP3_TX_GPIO_Port, MP3_TX_Pin);

    HAL_GPIO_DeInit(MP3_RX_GPIO_Port, MP3_RX_Pin);
